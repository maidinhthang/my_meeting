    ...
    <Container fluid>
      ...
      >
        <Col className="next p-3">
          ...
          <Row className="mt-3 team px-3">
            <Col>
              <span style={{ fontWeight: "500", color: "#B4B4B8" }}>Team</span>
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
